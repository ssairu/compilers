...
Размер типа Color: 4 байт
Размер типа ScreenType: 4 байт
Размер типа ScreenChar: 9 байт
Размер типа TextScreen: 17280 байт
Размер типа GraphicScreen: 1228800 байт
Размер типа Screen: 1228800 байт
Размер типа Token: 20 байт
Семантических ошибок не найдено
```

# Вывод
В процессе выполнения данной лабораторной работы мною были освоены 
навыки семантического анализа и обработки координат, ошибок в 
библиотеке parser_edsl.